...
const CompetitionCreatePage = () => {
    ...
    const {loading, createCompetition, resetTimer} = useCompetition();
    ...
    const handleCreateCompetition = async (e: FormEvent) => {
        ...
        try {
            const roomId = await createCompetition(subject, timeLimit, competitionLanguage, constraints);
                        ...
                        <form onSubmit={handleCreateCompetition} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setCompetitionLanguage(e.target.value)}
